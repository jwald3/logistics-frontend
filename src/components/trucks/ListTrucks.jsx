...
const ListTrucks = () => {
    ...
    const actions = [
        {label: "View", cName: 'btn btn-info', func: viewTruck },
    ]
        ...
        <div className='container'>
            <div className='sub-container'>
               <h2 className='text-center'>Truck List</h2>
                <ListTable data={paginatedTrucks} headers={headers} actions={actions} id={"id"}/>
                <div className='top-btns'>
                    <button className='add-btn' onClick={() => navigate("/trucks/add")}>Add Truck</button>
