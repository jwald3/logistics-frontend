                ...
                <div className="truck-update-form">
                    <form onSubmit={saveTruck}>
                        <div className='form-group'>
                            ...
                            <input placeholder='Truck License Plate' name="license" className="form-control" 
                                value={license} required onChange={(event) => setLicense(event.target.value)}/>
                        </div>
                        <div className='form-group'>
                            <label>Truck Capacity:</label>
                            <input placeholder='Truck Capacity' name="capacity" className="form-control" 
                                value={capacity} required onChange={(event) => setCapacity(event.target.value)}/>
                        </div>
