...
const ViewFacility = () => {
    ...
    const associatedTrips = trips.filter(
            trip => trip.originFacility.name === facility.name || 
            ...
            <div className="facility-sub-container">
                ...
                <div className="facility-info">
                    ...
                    <div className="facility-button-row">
                        <button style={{marginLeft: "10px"}} className='btn btn-warning' onClick={() => updateFacility(facility.id)}>
                            Update
                        </button>
                        <span style={{margin: "0px"}} data-bs-toggle="tooltip" title="Cannot delete facility belonging to a trip">
                            <button  
                        ...
                        <button style={{marginLeft: "10px"}} className='btn btn-secondary' onClick={() => navigate("/facilities")}>
                            Back
                        </button>
                    </div>
                </div>
